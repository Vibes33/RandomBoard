...
urlpatterns = [
    ...
    path("panel/api/pools/<int:pool_id>/reset", api.api_pool_reset),
    path("panel/api/pools/<int:pool_id>/types", api.api_pool_data_types),
    path("panel/api/pools/<int:pool_id>/types/<str:type_key>/reset", api.api_pool_type_reset),
    path("panel/api/pools/<int:pool_id>/types/<str:type_key>/refetch", api.api_pool_type_refetch),
    path("panel/api/data", api.api_data_overview),
    path("panel/api/data/reset-all", api.api_data_reset_all),
